...
while_main:
    ...
    JSRD #set_out_number                ; Default settings of display and buttons interface             
...
set_out_number:                         ; Default settings of display and buttons interface             CALL THIS ;FUNCTION WHICH SECOND AND WICH INTERRUPTION TO CHANGE THE VALUES ARRAY
                                        ; param  : R2       <- Value with 2 digits to display (0-99)
                                        ; param  : R3       <- Posision on display_values related with this timer 
                                        ; return : NONE
